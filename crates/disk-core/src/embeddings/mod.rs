...
pub use paths::{is_co_storage_path, manifest_rel_path, vector_blob_rel_path, CO_STORAGE_ROOT};
pub use scan::{scan_share_embeddings, ShareEmbeddingsReport, SourceSidecarStatus};
pub use write::{normalize_source_rel, write_sidecar, WriteSidecarError, WriteSidecarResult};
